...
const useStyles = makeStyles((theme) => ({
  ...
  tab: {
    ...
    minWidth: 8,
    opacity: 1,
    "&:hover": { opacity: 0.8, color: theme.palette.common.white },
  },
  menu: {
...
export default function Header(props) {
  ...
  const routes = [
    ...
    { name: "Teaching-method", link: "teaching-method", activeIndex: 2 },
    { name: "Events", link: "events", activeIndex: 3 },
  ];
...
//         <MDBContainer>
//           <MDBNavbarBrand>
//             <Link to="/" className="white-text h2 transparentOn">Sodiey</Link>
//           </MDBNavbarBrand>
//           <MDBNavbarNav right>
//             <MDBNavItem>
...
//             </MDBNavItem>
//             <MDBNavItem>
//               <MDBNavLink to="/landing" className="ransparentOff">Landing</MDBNavLink>
//             </MDBNavItem>
//           </MDBNavbarNav>
//         </MDBContainer>
//       </MDBNavbar>
